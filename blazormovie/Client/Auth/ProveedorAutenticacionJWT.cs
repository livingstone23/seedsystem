...
namespace blazormovie.Client.Auth
{
    ...
    public class ProveedorAutenticacionJWT : AuthenticationStateProvider, ILoginService
    {
        ...
        /// <summary>
        /// Metodo que permite se ejecuta al usuario entrar a la aplicacion, confirma si el usuario esta autenticado
        ...
        public async override Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            //Utilizacion de metodos autilizares
        ...
        /// <summary>
        /// Metodo auxiliar para consutrir token
        /// </summary>
        ...
        /// <summary>
        /// Metodo auxiliar creado por microsoft
        /// </summary>
